...
class DocumentationExampleTests(unittest.TestCase):
    ...
    def test_policy_authoring_direction_defines_rigid_modes(self):
        ...
        for expected in (
            ...
            "WholeTableReader",
            "Writer",
            "Writers should always have reader capability",
            "atomic generated grant pair",
            "drift risk gets larger",
            "writer generated grant pairs that drift apart",
            "writer access models that fail to generate whole-table",
            "allowed_grant_models",
            "contains_pii",
            "strict",
            "migration",
            "audit",
            "Non-Negotiable Guardrails",
            "writer/editor/admin models using tag keys",
