...
The audit, validate, lint, plan, sample, bootstrap, schema, permissions,
completion, and doctor commands do not mutate AWS state. `lfguard apply` is also
a dry run unless `--execute` is provided.
